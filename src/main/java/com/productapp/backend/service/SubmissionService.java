...
public class SubmissionService {
    ...
    public PageResponse<SubmissionSummaryResponse> adminGetAll(
            ...
            String serviceNumber, String searchQuery, Boolean assigned, LocalDateTime from, LocalDateTime to, Pageable pageable) {

        Page<Submission> page = submissionRepository.findAllFilteredPaged(
                surveyorId, status, serviceNumber, division, searchQuery, assigned, from, to, pageable);
